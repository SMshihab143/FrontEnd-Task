...
export default function CreateStore() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 mt-10 border rounded shadow-lg">
      <h1 className="text-2xl font-bold mb-6 text-center">Create Your Online Store</h1>
      <form onSubmit={handleSubmit} noValidate>
        {/* Store Name */}
        <div className="mb-4">
          <label htmlFor="name" className="block font-semibold mb-1">Store Name</label>
          <input
            type="text"
            id="name"
            name="name"
        ...
        {/* Domain */}
        <div className="mb-4">
          <label htmlFor="domain" className="block font-semibold mb-1">Subdomain</label>
          <input
            type="text"
            id="domain"
            name="domain"
        ...
        <div className="mb-4">
          ...
          <select
            ...
            value={form.currency}
            onChange={handleChange}
            className={`w-full border px-3 py-2 rounded ${errors.currency ? "border-red-500" : "border-gray-300"}`}
            required
          >
